...
if ganancia < 0:
    st.error("🔴 Este producto genera pérdidas. Revisá tus costos.")
else:
    st.success("🟢 Este producto es rentable.")
...
if all(v >= 0 for v in valores):
    ...
    st.warning("No se puede mostrar el gráfico porque uno o más valores son negativos.")
